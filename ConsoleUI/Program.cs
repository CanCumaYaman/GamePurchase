...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void SoldGameOperatons()
        {
            ...
            soldGameManager.Add(new SoldGame { GameName = "PUBG", GamerName = "Can Cuma", GamerLastName = "YAMAN", GamerIdentityNumber = "11683333334", CampaignName = "Teacher", CampaignEndDate=new DateTime(2022,04,04), SoldDate = new DateTime(2021, 02, 06) });
        }
